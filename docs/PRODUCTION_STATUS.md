...
| G1-B 物理試作 | 開始禁止 | G1-A通過と保存部品の用途限定後に開始 |
...
4. iPhone Safariで環境表示、画面高さ、検索除外、設定環境を確認していない
5. G1-Aマージ後の確認ページ終了処理を確認していない
6. 既存の汎用保存部品を設定専用へ狭める実装方針がコードへ未反映
...
7. 汎用保存部品を設定専用へ狭め、ゲーム記録保存を禁止する試験を追加
8. G1-B物理試作のDraft PR
9. Vitest、Playwright、iPhone・iPad結果
10. Planck.js、物理Hz、発射、球受けの判断
11. G2で中心体験とショットマップを確定
