...
- 対象PR: 作成前
- 現在の段階: ゲームエンジニアレビュー反映中 / G0.5・G1開始前
...
| 項目 | 状態 | 内容 |
|---|---|---|
| 計画体系 | 改訂中 | ゲームループ、物理イベント、状態遷移、自動試験、PRプレビューを追加 |
| G0 制作目的 | 通過 | カメレオンJPの代表作候補として制作 |
| G0.5 市場・名称 | 未着手 | 8〜12作品比較と名称確認が必要 |
| G1 技術試作 | 開始待ち | 本PRのマージ後に実装可能 |
