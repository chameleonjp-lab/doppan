...
CI、Playwright、iPhone実機確認は[自動試験・確認ページ計画](./TEST_AND_PREVIEW_PLAN.md)を正本とする。
...
> 再現可能な依存関係、CI、Chromium・WebKit試験、単一GameLoop、GitHub Pagesの未告知確認枠を成立させ、iPhone Safariから安全に確認できること。
